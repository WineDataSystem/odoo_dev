...
class avancement_ca_client_list(osv.osv):
    _name = "avancement.ca.cust.salesteam.list"
    _description = "Avancement CA détail Clients dans une sales team"
    _auto = False
    _rec_name = 'id'
    ...
    def _select(self):
        select_str = """
            select id, section_id, partner_id,qty_annee, qty_prev_annee, balance_annee,balance_prev_annee,
